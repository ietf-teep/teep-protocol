  ...
  +------------+           +-------------+
    ...
    QueryRequest ------->
                 ...
                 <-------     or
                             ...
                             Error
~~~~
{: #fig-query-overview title="QueryRequest and QueryResponse Message Flow"}
 ...
 +------------+           +-------------+
             ...
             Update  ---->
                    ...
                    <----    or
                            ...
                            Error
~~~~
{: #fig-update-overview title="Update Message Flow"}
...
1. Create a TEEP message according to the description below and populate
  ...
  using a cryptographically secure random source (see {{RFC8937}} and {{RFC4086}}).  Subsequent token values
...
: The attestation-payload parameter contains an Attestation Result. If the
  ...
  the encoding defined in {{RFC9711}}.  See {{attestation}} for further
  discussion.
...
If the QueryResponse instead contains Evidence, the TAM passes
...
If the QueryRequest is instead determined to contain Evidence, the TEEP Agent
...
operational guidelines in the IETF operations-area document {{I-D.ietf-opsawg-rfc5706bis}}
